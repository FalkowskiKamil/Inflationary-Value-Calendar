...
from manager.options_data import get_options_currency_data, get_options_goods_prices_data,\
...
def api_options_collector(list_type: str) -> list:
    data_list = None
    if list_type == "country" or list_type == "inflation":
        data_list = get_options_inflation_country_data()
    elif list_type == "goods":
        data_list = get_options_goods_prices_data()
    elif list_type == "currency":
        data_list = sorted(set(get_options_currency_data().values()))
    return data_list
